...
// 1=MG 2=PHmm 3=PHtt 4=ttbar 5=WW 6=WZ 7=ZZ
//const double MCfile=1;
const double
  PTCUT1 = 20,
  PTCUT2 = 30,
  ETACUTMUON = 2.4,
...
class AnalyzerPS : public TSelector {
public :
 ...
 ostringstream ss;
  ...
  double acop, theta, phiStar, phiStarMC, phiStarMCN, phiStarMCB, phiStarMCD;
double acopMC, thetaMC;
double acopMCN, thetaMCN;
double acopMCD, thetaMCD;
double acopMCB, thetaMCB;
 ...
 TH1D* h_phiStar;
    TH1D* h_phiStarem;
  TH1D* h_phiStarRapid1;
  TH1D* h_phiStarRapid2;
  TH1D* h_phiStarRapid3;
  TH1D* h_phiStarRapid4;
  TH1D* h_phiStarRapid5;
  TH1D* h_RapidphiStar1;
  TH1D* h_RapidphiStar2;
  TH1D* h_RapidphiStar3;
  TH1D* h_RapidphiStar4;
  TH1D* h_phiStarMC;
  TH1D* h_phiStarMCN;
  TH1D* h_phiStarMCB;
  TH1D* h_phiStarMCD;
  ...
  TH1D* h_EMPSS1IM;
   ...
   TBranch        *b_MCD14vector;   //!
   TBranch        *b_MCD24vector;   //!
   TBranch        *b_MCN14vector;   //!
   TBranch        *b_MCN24vector;   //!
   TBranch        *b_MCB14vector;   //!
   TBranch        *b_MCB24vector;   //!
   ...
   AnalyzerPS(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~AnalyzerPS() { }
...
#ifdef AnalyzerPS_cxx

void AnalyzerPS::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("MCN1Q", &MCN1Q, &b_MCN1Q);
   fChain->SetBranchAddress("MCN2Q", &MCN2Q, &b_MCN2Q);
   fChain->SetBranchAddress("MCB1Q", &MCB1Q, &b_MCB1Q);
   fChain->SetBranchAddress("MCB2Q", &MCB2Q, &b_MCB2Q);
   fChain->SetBranchAddress("MCD1Q", &MCD1Q, &b_MCD1Q);
   fChain->SetBranchAddress("MCD2Q", &MCD2Q, &b_MCD2Q);
   ...
   fChain->SetBranchAddress("MCD14vector", &MCD14vector, &b_MCD14vector);
   fChain->SetBranchAddress("MCD24vector", &MCD24vector, &b_MCD24vector);
   fChain->SetBranchAddress("MCB14vector", &MCB14vector, &b_MCB14vector);
   fChain->SetBranchAddress("MCB24vector", &MCB24vector, &b_MCB24vector);
   fChain->SetBranchAddress("MCN14vector", &MCN14vector, &b_MCN14vector);
   fChain->SetBranchAddress("MCN24vector", &MCN24vector, &b_MCN24vector);
